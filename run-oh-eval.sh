...
clang-3.9 -g -c -emit-llvm $source_input -o OH-build/input.bc -Xclang -DVERSION=\"1.0.1\"
...
opt-3.9 -load /usr/local/lib/libInputDependency.so -load  OH-build/lib/liboblivious-hashing.so OH-build/input.bc -oh-insert -num-hash 1 -o OH-build/out.bc
...
# precompute hashes
clang++-3.9 -g -lncurses -rdynamic -std=c++0x OH-build/out.bc -o OH-build/out
